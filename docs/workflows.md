...
- Execution pairing rule: if `docs/workflows.md` changes due to command/order updates, refresh paired execution paths under both AGENTS roots.
...
- Path pair rule: `docs/workflows.md` pairs with `AGENTS/03-execution/008-implementation-plan.md` for setup, verify, and failure-triage order.
...
- Keep maintainer runbook context in `docs/workflows.md`; keep step-by-step agent execution plan in `AGENTS/workflows.md` (or layered execution docs).
...
- Maintainer runbook context lives in `docs/workflows.md`, while step ordering for agent actions lives in paired AGENTS execution docs.
