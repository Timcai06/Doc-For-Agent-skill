...
- Product pairing rule: if `docs/overview.md` changes due to scope/value decisions, refresh paired product paths under both AGENTS roots.
...
- Path pair rule: `docs/overview.md` pairs with `AGENTS/01-product/001-core-goals.md` for agent-facing product rules and scope guardrails.
- Path pair rule: `docs/overview.md` pairs with `AGENTS/01-product/002-prd.md` for agent-facing user and outcome contract.
- Path pair rule: `docs/overview.md` pairs with `AGENTS/01-product/003-app-flow.md` for agent-facing flow and entry-surface notes.
...
- Keep user/value framing in `docs/overview.md`; keep edit-time operating rules in `AGENTS/product.md` (or layered product docs).
...
- Product intent lives in `docs/overview.md`, while execution-facing preservation rules live in paired AGENTS product docs.
