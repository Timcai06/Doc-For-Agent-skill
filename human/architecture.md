...
- Architecture pairing rule: if `human/architecture.md` changes due to boundary/source-of-truth updates, refresh paired architecture paths under both AGENTS roots.
...
- Path pair rule: `human/architecture.md` pairs with `AGENTS/02-architecture/004-tech-stack.md` for stack facts and platform anchors.
- Path pair rule: `human/architecture.md` pairs with `AGENTS/02-architecture/007-architecture-compatibility.md` for source-of-truth and compatibility rules.
...
- Keep architecture rationale in `human/architecture.md`; keep CLI/build/source-of-truth guardrails in `AGENTS/architecture.md` (or layered architecture docs).
...
- Architecture rationale lives in `human/architecture.md`, while operational boundaries for agents live in paired AGENTS architecture docs.
